...
class web_requests(object):
    ...
    def interface(self,interface_path,**My_date):
        url = "https://api.imways.com/mall/order/page/list"
        hraders = {":authority": "api.imways.com",
                    ":method": "POST",
                   ":path": "/mall/order/page/list",
                   ":scheme": "https",
                   ...
                   "origin": "https://a.imways.com",
                   "pragma": "no-cache",
                   "referer": "https://a.imways.com/",
                   "sec-fetch-dest": "empty",
                   "sec-fetch-mode": "cors",
                   "sec-fetch-site": "same-site",
                   "tk": "MTE3OGRkMGQtNzg2YS00MDc3LWFlMzktNTU2NjQxODE0MTNhMTU4NzEyNTUyNTA=c3RhZmY=MTU4NTI5MTMwMw==",
                   "user-agent": "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/80.0.3987.149 Safari/537.36"}
        data = My_date
        r = requests.get(url=url,json=data,headers=hraders)
        print(r.text)
        print(r.status_code)
...
a = web_requests()
    # a = web_requests()
a.Interface('monitor/sxsb-sxzl', saleStartTime="2020-02-26", saleEndTime="2020-03-27")
    # a.interface(saleStartTime="2020-02-26",saleEndTime="2020-03-27")
